...
namespace cvPageWeb.Controllers
{
    ...
    public class EditController : Controller
    {
        ...
        [HttpPost]
        public ActionResult EditProfile(TBL_SINGULAR_INFO p, TBL_MEMBERS m, HttpPostedFileBase profile_photo)
        {
            ...
            singular_info.photo_visible = p.photo_visible;
            ...
            else
            {
                ...
                //Bitmap b = (Bitmap)Bitmap.FromStream(profile_photo.InputStream);
                ...
                var newImage = new WebImage(profile_photo.InputStream);
                ...
                filePath = "/img/profile_photos/" + DateTime.Now.ToString("dd_MM_yyyy") + "__" + DateTime.Now.ToString("HH_mm") + "__" + p.member_id + imageFileName;
        ...
        public ActionResult Update_Experience_Data(TBL_EXPERIENCE p)
        {
            ...
            experience_info.city = p.city;
            experience_info.work_type = p.work_type;
        ...
        public PartialViewResult City_List()
        {
            var city_list_ = db.TBL_CITY_LIST.ToList();
            return PartialView(city_list_);
        }
        public PartialViewResult Work_Type_List()
        {
            var work_type_list_ = db.TBL_WORK_TYPE_LIST.ToList();
            return PartialView(work_type_list_);
        }


        public PartialViewResult City_List_Autocomplete()
        {
            //var work_type_list_ = db.TBL_WORK_TYPE_LIST.ToList();
            return PartialView();
        }
        ...
        [HttpPost]
        public JsonResult City_List_Autocomplete(string Prefix)
        {
